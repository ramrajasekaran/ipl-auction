...
const PlayerCard = ({ player, currentBid, lastSoldPlayer, currentBidderName }) => {
    if (!player) {
        ...
        if (lastSoldPlayer) {
            return (
                <div className={`h-[200px] w-full max-w-xs glass-panel rounded-2xl flex items-center justify-center flex-col p-4 border-2 ${lastSoldPlayer.isUnsold
        ...
        return (
            <div className="h-[200px] w-full max-w-xs glass-panel rounded-2xl flex items-center justify-center flex-col text-slate-500 animate-pulse">
