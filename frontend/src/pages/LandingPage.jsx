            ...
            <div className="grid md:grid-cols-2 gap-6 w-full max-w-4xl">
                <Link to="/manager" className="group">
                    ...
                    >
                        ...
                        <h2 className="text-3xl font-bold text-white mb-2 uppercase tracking-wide">Manager Zone</h2>
                        ...
                        <p className="text-slate-300 mb-8 font-light">
                            Take charge of the auction. Set the rules, control the budget, and lead the bidding war.
                        </p>
