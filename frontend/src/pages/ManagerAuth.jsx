...
import { ArrowLeft, Save, Play, Lock, Hash, IndianRupee, Eye, EyeOff } from 'lucide-react';
...
const ManagerAuth = () => {
    ...
    return (
        <div className="h-screen flex flex-col items-center justify-start md:justify-center p-4 pt-20 md:pt-4 overflow-hidden">
            <motion.button
