...
const WelcomeScreen = () => {
    ...
    return (
        <div className="min-h-screen md:h-screen bg-slate-950 flex flex-col items-center justify-start p-4 md:p-6 relative overflow-y-auto md:overflow-hidden">
            ...
            >
                <h1 className="text-4xl md:text-6xl font-black text-white mb-2 uppercase italic px-4">
                    IPL <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-500 pr-4">Auction</span>
                </h1>
